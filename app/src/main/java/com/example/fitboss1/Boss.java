...
//        int strengthLvl = bundle.getInt("Strength");
//    }
//    Bundle bundle = getIntent().getExtras();
//    int playerLvl = bundle.getInt("Level");
//    int strengthLvl = bundle.getInt("Strength");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timer = new CountDownTimer( 30000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent primIntent = new Intent(Boss.this, out_of_time.class); // BRYSON replace
                startActivity(primIntent);
                playerLvl+=50;
                Intent LVLtoMain = new Intent(Boss.this, MainActivity.class);
                LVLtoMain.putExtra("LVL",playerLvl);
            ...
            public void onClick (View view) {
                if(Check == true) {
                    if ((health)- 2*strengthLvl > 0) {
                        ...
                        timer.cancel();
                        Intent primIntent = new Intent(Boss.this, you_win.class); // BRYSON replace
                        startActivity(primIntent);
                        playerLvl +=500;
                        Intent LVLtoMain = new Intent(Boss.this, MainActivity.class);
                        LVLtoMain.putExtra("LVL",playerLvl);
